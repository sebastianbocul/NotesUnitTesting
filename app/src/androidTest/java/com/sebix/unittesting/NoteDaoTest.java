...
public class NoteDaoTest extends NoteDatabaseTest {
    ...
    public static final String TEST_CONTENT = "This is a test contnet";
    ...
    public void insertReadUpdateReadDelete() throws Exception{
        ...
        getNoteDao().updateNotes(note).blockingGet();
    ...
    public void insert_nullTitle_throwSQLiteConstrainException() throws Exception{
    ...
    @Test(expected = SQLiteConstraintException.class)
    public void updateNote_nullTitle_throwSQLiteConstrainException() throws Exception{
        Note note = new Note(TestUtil.TEST_NOTE_1);
